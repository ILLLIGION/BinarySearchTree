...
public:
	...
	auto insert(const T& value) -> bool try
	{
	...
	{
		std::cerr << "insert(" << value <<  ") threw an exception" << std::endl;
		std::cerr << err.what() << std::endl;
		return false;
	}
	
	auto find(const T& value) const -> const T* try
	{
		if (!root_)
	...
	{
		std::cerr << "find(" << value << ") threw an exception" << std::endl;
    		std::cerr << err.what() << std::endl;
		return nullptr;
	}
	
	auto remove(const T& value) -> bool try
	{
